 ...
 * [collections-ontology.yml](collections-ontology.yml)
     * Determines how your purl.obolibrary.org/obo/collections-ontology/ redirects will be handled
     ...
     * Paste in the contents of [collections-ontology.yml](collections-ontology.yml)
 ...
 * [collections-ontology.md](collections-ontology.md)
     ...
     * Paste in the contents of [collections-ontology.md](collections-ontology.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
